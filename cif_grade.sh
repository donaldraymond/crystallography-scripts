...
#check if grade is installed
if hash grade 2>/dev/null; then
...
#Set obabel flag
export BDG_TOOL_OBABEL=none

#Run Grade
grade $SMILES_string -resname $ligandID -name $fileName -ocif $fileName.cif -opdb $fileName.pdb -nomogul
